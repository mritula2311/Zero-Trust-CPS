...
| Relational model status | M6 is selected in the standalone benchmark; a separate M6 checkpoint is configured in serving; [07](07_RELATIONAL_MODELS_M1_M9.md) and [10](10_FUSION_AND_PROCESS_TRUST.md) |
...
| Policy | P5 contextual bandit selected in runtime; P6 constrained static comparator; [11](11_POLICY_ENGINE.md) |
...
| Hardware result | Preserved GCN-era post-warm-up MPU:30/30 disturbances,5/12 resting false alarms; [13 Q](13_RESULTS_MASTER_TABLES.md) |
...
| Limits | Fixed-split refit CIs; no held-out SW; M6 comparative/training/policy provenance gaps; no full physical network; [18](18_LIMITATIONS_AND_THREATS_TO_VALIDITY.md) |
