...
| Process | Rule+IF+LSTM→runtime GCN→four-score logistic fusion; high means normal; [10](10_FUSION_AND_PROCESS_TRUST.md) |
...
| Final relational candidate | M6, standalone only; all nine models in [07](07_RELATIONAL_MODELS_M1_M9.md) |
