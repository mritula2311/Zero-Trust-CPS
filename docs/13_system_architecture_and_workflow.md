...
> **2026-09-05 audit update, [UPDATED 2026-09-07]:** Distinguish as-built Rule/IF/LSTM/GCN fusion from experimental Set Transformer. Physical Device 2 (SW-420) had its first real capture, TRAIN split only, as of 2026-09-05; as of 2026-09-07 it also has held-out VALIDATION/TEST captures (`results/sw420_real_hardware/`, doc 13 Q2) — standalone, separate from its still-pending slot in the constructed network benchmark. M9 has training at 15 slots but no saved 15-node test.
