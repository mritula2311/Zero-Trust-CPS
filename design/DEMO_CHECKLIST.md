...
SW-420 (`esp32-vib-002`) now has TRAIN/VALIDATION/TEST physical evidence (closed 2026-09-07, `results/sw420_real_hardware/`); this dashboard/demo checklist itself was not re-verified against the new sessions as part of that closure. A dual-abnormal reproducible demo is **NOT CURRENTLY SUPPORTED** by the dashboard/runner. No live replay/coordinated control is claimed.
